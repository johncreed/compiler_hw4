...
char *printLabelString(FILE *fp, AST_NODE *astNode) {
    ...
    case EXPR_NODE:
        ...
        case UNARY_OPERATION:
            fprintf(fp, "%s", unaryOpString[astNode->semantic_value
                                                .exprSemanticValue.op.unaryOp]);
            break;
        }
        break;
    case CONST_VALUE_NODE:
        ...
        case FLOATC:
            ...
            break;
        case STRINGC:
            astNode->semantic_value.const1->const_u
                .sc[strlen(astNode->semantic_value.const1->const_u.sc) - 1] = 0;
            fprintf(fp, "\\\"%s\\\"",
                    astNode->semantic_value.const1->const_u.sc + 1);
            astNode->semantic_value.const1->const_u
                .sc[strlen(astNode->semantic_value.const1->const_u.sc)] = '"';
            break;
        }
        break;
