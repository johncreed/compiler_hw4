...
typedef enum EXPR_KIND { BINARY_OPERATION, UNARY_OPERATION } EXPR_KIND;
...
typedef struct STMTSemanticValue { STMT_KIND kind; } STMTSemanticValue;
...
typedef struct TypeSpecSemanticValue { char *typeName; } TypeSpecSemanticValue;
